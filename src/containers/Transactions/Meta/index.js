  ...
  render() {
    ...
    return (
      <div className="section">
        ...
        <div>{t('number_of_affected_node', { count: data.meta.AffectedNodes.length })}</div>
        {TransactionMeta.renderNodesMeta(t, language, 'created', affectedNodes.created, data.tx)}
        {TransactionMeta.renderNodesMeta(t, language, 'modified', affectedNodes.modified, data.tx)}
        {TransactionMeta.renderNodesMeta(t, language, 'deleted', affectedNodes.deleted, data.tx)}
      </div>
    );
  }
}
